...
df_train['text'] = df_train['text'].apply(lambda x: rebuild_word(x, G, 0.2))
df_validation['text'] = df_validation['text'].apply(lambda x: rebuild_word(x, G, 0.2))
df_test['text'] = df_test['text'].apply(lambda x: rebuild_word(x, G, 0.2))
